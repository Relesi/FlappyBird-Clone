...
public class FlappyBird extends ApplicationAdapter {
   ...
   // private int movimento = 0;
    ...
    private int estadoJogo = 0; // 0-> Jogo não iniciado 1-> jogo iniciado 2-> jogo - Tela  Game Over
    ...
    public void create() {
        ...
        fonte.setColor(com.badlogic.gdx.graphics.Color.WHITE); //Diferente do video
        ...
        * */
        ...
        camera.position.set(VIRTUAL_WHIDTH / 2, VIRTUAL_HEIGHT / 2, 0);
        viewport = new StretchViewport(VIRTUAL_WHIDTH, VIRTUAL_HEIGHT, camera);
        //viewport = new FitViewport(VIRTUAL_WHIDTH, VIRTUAL_HEIGHT, camera);
    ...
    public void render() {
        ...
        if (estadoJogo == 0) {//Não iniciado
            ...
            if(estadoJogo == 1){
                ...
                if (Gdx.input.justTouched()) {
                    //Gdx.app.log("Tpque", "Toque na tela");
                    velocidadeQueda = -15;
                }
